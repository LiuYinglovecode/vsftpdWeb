...
<td> <a href=<?=$del?> class="delete" onclick="return confirm('This is a not recoverable action!!! Are you certain you want to delete the user and all his data?')">Delete</a> </td>
